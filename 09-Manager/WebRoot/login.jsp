...
<div class="logintop">    
    ...
    <div style="text-align:center;">
    	<span style="font-size:15px;color:dark-red;font-weight: bold; ">用户名或者密码错误</span> 
    </div>
    <%} %>
    <%
    	//声明Java代码块进行密码修改提示语
    ...
    %>
    <div style="text-align:center;">
    	<span style="font-size:15px;color:dark-red;font-weight: bold; ">密码修改成功</span> 
    </div>
    <%} 
    ...
    %>
    <div style="text-align:center;">
    	<span style="font-size:15px;color:dark-red;font-weight: bold; ">注册成功</span> 
    </div>
    <%} 
    ...
    <div class="loginbm">版权所有  WZzz  <a href="https://mail.163.com/">cheerwz@163.com</a>  仅供学习交流，勿用于任何商业用途，交流QQ：1781192805</div>
